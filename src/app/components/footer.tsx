    ...
    <Container>
      ...
      >
        <div className="relative z-10">
          <div
            className={`grid grid-cols-1 md:grid-cols-4 gap-8 justify-items-center text-center md:justify-items-start md:text-left transition-all duration-1000 ease-out ${
              isVisible
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                />
                <span
                  className="text-2xl font-semibold text-yellow-500/25 bg-gradient-to-r from-yellow-500 to-orange-500
              ...
              <p className="text-neutral-400 mb-6 font-ubuntu leading-relaxed">
                Создаем современные веб-решения, <br />
                которые помогают бизнесу расти и <br />
            ...
            >
              <h3 className="text-lg font-semibold text-white mb-4 font-ubuntu">
                Услуги
              </h3>
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/#services"
                    className="text-neutral-400 hover:text-yellow-500 transition-colors duration-300 font-ubuntu"
                  >
                    Разработка сайтов
                  </Link>
                </li>
            ...
            >
              <div className="text-lg font-semibold text-white mb-2 font-ubuntu">
                Мы в соцсетях:
              </div>
              <div className="flex gap-4 mt-2 justify-center md:justify-start">
                <a
                  ...
                  className="p-3 rounded-full bg-[#181f2e] hover:bg-blue-500/20 transition group shadow-lg hover:shadow-blue-400/30"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-full bg-[#181f2e] hover:bg-pink-500/20 transition group shadow-lg hover:shadow-pink-400/30"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 rounded-full bg-[#181f2e] hover:bg-green-500/20 transition group shadow-lg hover:shadow-green-400/30"
                >
          ...
          <div
            className={`mt-12 pt-8 border-t border-yellow-500/10 transition-all duration-1000 delay-800 ease-out ${
              isVisible
                ? "translate-y-0 opacity-100"
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left">
              <p className="text-neutral-400 text-sm font-ubuntu">
                ...
                <span className="ml-4 text-yellow-500/70">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0 justify-center md:justify-start">
                <Link
                  href="/privacy"
                  className="text-neutral-400 hover:text-yellow-500 transition-colors duration-300 text-sm font-ubuntu"
                >
