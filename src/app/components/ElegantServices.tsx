              ...
              {dropdownOpen && (
                ...
                >
                  {services.map((service) => (
                    <li
                      key={service.id}
                      className={`flex items-center gap-3 px-5 py-4 cursor-pointer transition-all duration-200 hover:bg-yellow-500/10 ${
            ...
            >
              <div
                className={`
                  ...
                  ${
                    selectedService === service.id
                      ? "border-yellow-500/30 bg-white/10 -translate-y-1 shadow-2xl shadow-yellow-500/10 scale-105"
                      : ""
                  }
                  ${
                    selectedService !== service.id
                      ? "hover:border-yellow-500/30 hover:bg-white/10 hover:-translate-y-1 hover:shadow-2xl hover:shadow-yellow-500/10 hover:scale-105"
                      : ""
                  }
                `}
              >
                {/* Иконка */}
                <motion.div
                  className={`w-12 h-12 rounded-lg mb-4 flex items-center justify-center text-white transition-transform duration-300 ${
                ...
                <h3
                  className={`text-xl font-semibold text-white mb-2 transition-colors duration-300 ${
                    selectedService === service.id ? "text-yellow-400" : ""
                  } ${
                    selectedService !== service.id
            ...
            >
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <div className="space-y-4">
                    <button
                      className="w-full bg-white text-gray-900 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300"
                      onClick={() => {
                        setFormModalOpen("order");
                        setServiceType(selectedServiceData.title);
                      }}
                    >
                      Заказать проект
                    </button>
                    <button
                      className="w-full bg-gray-800/50 text-gray-300 py-3 rounded-lg font-semibold border border-gray-600 hover:bg-gray-700/50 transition-colors duration-300"
                      onClick={() => {
                        setFormModalOpen("consult");
                        setServiceType(
                          selectedServiceData.title + " (консультация)"
                        );
                      }}
                    >
