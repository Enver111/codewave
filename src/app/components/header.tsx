...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-40 px-6 transition-all duration-500 ease-out ${
        isScrolled
    ...
    >
      ...
      <Modal open={loginModalOpen} onClose={() => setLoginModalOpen(false)}>
        ...
        <p className="text-lg text-gray-200 mb-2">
          Мы уже работаем над системой авторизации 🚀
        </p>
        <p className="text-sm text-gray-400">
          Следите за обновлениями — совсем скоро вы сможете войти и получить
          больше возможностей!
        </p>
      </Modal>
    </header>
